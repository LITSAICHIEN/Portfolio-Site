$(document).ready(function(){var r=$("#slides div").length,i=0,s=0;function n(e){if(e==s)return!1;void 0===e&&(e=Number(s)+1),e==r&&(e=0),$("#slides .slider"+s).fadeOut("slow"),$("#thumbnail .slider"+s).removeClass("active"),$("#slides .slider"+e).fadeIn("slow"),$("#thumbnail .slider"+e).addClass("active"),s=e}function t(e){clearInterval(i),n(e),i=setInterval(n,5e3)}$("#slides .slider0").fadeIn("slow"),$("#thumbnail .slider0").addClass("active"),i=setInterval(n,5e3),$("#thumbnail div").bind("click",function(){var e=$(this);t(e.attr("class").replace("slider",""))}),$(".moveSlide").bind("click",function(){var e=$(this).attr("id").replace("slider","");t("Right"==e?s==r+1?0:s+1:0==s?r-1:s-1)})}),$(document).ready(function(){$(".center").slick({arrows:!0,prevArrow:'<img src="src/images/prev.jpg" class="slide-arrow prev-arrow">',nextArrow:'<img src="src/images/next.jpg" class="slide-arrow next-arrow">',centerMode:!0,infinite:!0,centerPadding:"60px",slidesToShow:3,responsive:[{breakpoint:768,settings:{arrows:!0,centerMode:!0,centerPadding:"40px",slidesToShow:3}},{breakpoint:480,settings:{arrows:!0,centerMode:!0,centerPadding:"40px",slidesToShow:1}}]})});
